...
[source,java]
----
include::{includesource}/examples/testing/ut-example/src/test/java/com/soebes/training/maven/simple/BitMaskTest.java[]
----
...
[source,xml]
----
include::{includesource}/examples/testing/ut-example/pom.xml[tags=first]
----
...
[source,xml]
----
include::{includesource}/examples/testing/ut-example-testng/pom.xml[]
----
