:includesource: ../../../examples/testing
...
[source,java]
----
include::{includesource}/ut-example/src/test/java/com/soebes/training/maven/simple/BitMaskTest.java[]
----
...
[source,xml]
----
include::{includesource}/ut-example/pom.xml[tags=first]
----
...
[source,xml]
----
include::{includesource}/ut-example-testng/pom.xml[]
----
