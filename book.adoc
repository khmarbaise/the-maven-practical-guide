...
=========================
Karl-Heinz Marbaise <the-maven-practical-guide@maven-practical-guide.com>
v0.0.5, 2015-09
:doctype: book
:toc: right
...
:link-junit: http://junit.org[JUnit]
:link-testng: http://testng.org[TestNG]

:link-mib: http://en.wikipedia.org/wiki/Binary_prefix#Specific_units_of_IEC_60027-2_A.2_and_ISO.2FIEC_80000[MiB]

:link-groovy: http://http://groovy-lang.org/[Groovy]
:link-scala: http://scala.org[Scala]
:link-ceylon: http://ceylon-lang.org[Ceylon]
:link-ruby: http://www.ruby-lang.org[Ruby]

:link-apache-software-foundation: https://www.apache.org/[Apache Software Foundation]

:link-mojo-plugins: https://www.mojohaus.orgplugins.html[MojoHaus's Plugin List]
...
:link-build-life-cycle: https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html[Build Life Cycle]
...
https://github.com/khmarbaise/maven-practical-guide/issues
...
include::different-environments.adoc[]

include::multi-module-builds.adoc[]
...
include::ci-solution.adoc[]

include::repository-manager.adoc[]

include::build-smells.adoc[]

include::plugin-development.adoc[]

include::performance.adoc[]

include::best-practice.adoc[]
